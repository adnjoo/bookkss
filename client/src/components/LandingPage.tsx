import landingImage from "@/assets/landing-section1.png";
import landingImage2 from "@/assets/landing-section2.png";
      ...
      <div className="my-4 bg-gray-100 py-10">
        <div className="mx-auto flex max-w-3xl flex-col-reverse px-4 sm:flex-row">
          ...
          <div className="flex justify-center sm:w-1/2">
            <img src={landingImage} alt="dashboard preview" />
          </div>
        </div>
      </div>
      <div className="my-4 bg-gray-100 py-10">
        <div className="mx-auto flex max-w-3xl flex-col-reverse px-4 sm:flex-row">
          ...
          <div className="flex justify-center sm:w-1/2">
            <img src={landingImage2} alt="discover preview" />
          </div>
        </div>
      </div>
    </>
